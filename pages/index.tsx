...
export default function Home() {
    ...
    const fetchProducts = useCallback(async () => {
        ...
        try {
            let response = await fetch(`http://localhost:8888/products/all?limit=${limit}`);
            let data = await response.json();

            if (sort === "desc") data.data.sort((a: any, b: any) => b.price - a.price);
        ...
        <Layout>
            ...
            <div>
                ...
                {selectedItems.length > 0 && (
                    <div className="mt-6">
                        <Button onClick={() => console.log(selectedItems)} className="mr-2 bg-red-500">
